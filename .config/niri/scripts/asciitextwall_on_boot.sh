...
AsciiTextWall -t "Just Another $(date +%A)" -f "cosmic" -s 30 -w 100 -c "#ebdbb2" -b "#282828" -n 'day_of_week.png' -o '~/Pictures/Backgrounds/Static/Asciiwall/' -mf '/usr/share/fonts/TTF/AgaveNerdFontMono-Regular.ttf'
